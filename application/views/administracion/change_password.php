		...
		<div class="row-fluid">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					...
					<form id="ChangePasswordForm" action-1="<?php echo base_url();?>auth/change_password">
						<div class="form-horizontal box-content">
						<div class="control-group">
							<label class="control-label" for="oldpassword">Contraseña Actual</label>
							<div class="controls">
								<input class="input-xlarge focused" id="oldpassword" name="oldpassword" type="password">
							</div>
						</div>
						<div class="control-group">
