		...
		<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="logistica_productos.html">Productos</a>
					</li>
				</ul>
			</div>
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2>PRODUCTOS</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-registrar btn-round" alt="Registrar Producto">
								<i class="icon-plus"></i>
							</a>
						</div>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="productos_table">
							...
							<tbody>
								<tr>
									...
									<td>
										<a class='btn btn-success btn-datos' href='producto_ver.html'>
