...
class Productos extends CI_Controller
{
	...
	public function registrar(){
		...
		if ($form!=null){
			...
			$Producto = array(
				'nLocal_id' =>$idLocal,'cProductoSerie' => $Serie,
				'cProductoTalla' =>$Talla,'nProductoMarca'=>$Marca,
				'nProductoTipo'=> $Tipo,'nCategoria_id' => $Categoria,
				'cProductoDesc' => $Descripcion,'cProductoImage' => $Imagen,
				'nProductoPContado' => $PContado,'nProductoPCredito'=>$PCredito,
				'nProductoPCosto'=>$PCosto,'nProductoStockMin'=>$StockMin,
				'nProductoStockMax'=>$StockMax,'nProductoStock'=>$Stock,
				'nProductoPorcUti'=>$PorcUti,'nProductoUtiBruta'=>$UtiBruta,
				'cProductoEst'=>$Estado,'clocalProducto_Estado'=>$clocalProducto_Estado );
